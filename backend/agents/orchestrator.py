...
class PantryOrchestrator:
    ...
    # ✅ UPDATED SIGNATURE TO ACCEPT EMAIL AND PHONE
    def process_incoming_message(self, raw_message: str, donor_email: str = None, donor_phone: str = None) -> Dict[str, Any]:
        orchestrator_logger.info(f"Received new task: {raw_message[:50]}...")
        
        # Pass the contact info down to the intake agent
        result = process_incoming_donation(raw_message, donor_email, donor_phone)
    ...
    def execute_post_approval_workflow(self, donation_id: str) -> Dict[str, Any]:
        ...
        if donation:
            ...
            orchestrator_logger.warning(f"Donation {donation_id} not found in pending queue.")
